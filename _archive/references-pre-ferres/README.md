...
Reactivating these does NOT undo the locale move — the SG/CPF/HFE rules now live in `locale-rules.md` and should stay there. If you reactivate, strip the locale lines from the reactivated brief or you reintroduce the leak the rebuild fixed.
