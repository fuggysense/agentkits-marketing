...
2. **Brand Guidelines**: For client work, read `clients/<slug>/_brand/brand-voice.md` (canonical voice and tone). Fall back to `./docs/brand-guidelines.md` only if no `_brand/brand-voice.md` exists for the client.
...
- **Brand Compliance**: For client work, follow `clients/<slug>/_brand/brand-voice.md`; fall back to `./docs/brand-guidelines.md` only if no client `_brand/brand-voice.md` exists.
...
| Need brand guidelines | `Read` | Load `clients/<slug>/_brand/brand-voice.md` (or `./docs/brand-guidelines.md` as fallback) |
...
- [ ] **Brand Aligned**: Matches voice in `clients/<slug>/_brand/brand-voice.md` (or `./docs/brand-guidelines.md` fallback)
...
- [[brand-voice-guardian]] (agent, 0.23)
- [[conversion-optimizer]] (agent, 0.20)
- [[researcher]] (agent, 0.19)
- [[copywriting]] (skill, 0.16)
