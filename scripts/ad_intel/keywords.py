...
VERTICAL_KEYWORDS: dict[str, dict] = {
    ...
    "dental": {
        ...
        "services": [
            ...
            "invisalign cost singapore", "dental implant cost singapore",
            "wisdom tooth removal cost singapore", "braces cost singapore",
            "root canal cost singapore", "dental crown cost singapore",
            "medisave dental", "medisave dental clinic", "chas dental clinic",
            "dental subsidy singapore", "chas dental subsidy",
            "emergency dental clinic singapore", "24 hour dentist singapore",
            "weekend dentist singapore", "walk-in dental clinic singapore",
            "cosmetic dentistry singapore", "dental aesthetics singapore",
        ],
        "local": [
            "dentist sg", "dental clinic singapore",
            "cheap dentist singapore", "polyclinic dental",
            "q&m dental", "national dental centre singapore",
            "unity denticare", "tp dental", "atria dental",
            "dentist tampines", "dental clinic orchard", "dentist bedok",
            "dental clinic jurong", "dentist woodlands", "dental clinic bishan",
        ],
    },
    "renovation": {
        "base": [
