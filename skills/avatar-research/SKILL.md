...
- Used by agents: `[[persona-builder]], [[copywriter]], [[researcher]]
- Related: `[[client-onboarding]]`, `[[offer-builder]]`

## When to Use This Skill

- Before running `/campaign:new`, a DCT concept wave (intent: "new ad concepts for <project>"), `/copy:email`, `/copy:ad`, video concept work, landing-page work, or funnel planning
...
- Invoke by intent, not a slash command — say "build avatars for <project>" or "audience segments for <project>" (routing-overrides sends these here)
...
8. Inform user: "Buyer-profile micro-personas ready. Start a DCT concept wave by saying 'new ad concepts for <project>' — it routes to ad-concept-engine Conductor Mode and generates the DCT batches."
...
| **Avatar-research** | Segment the buyer for ads | `buyer-profile.md` Micro-Persona Map (3-7 sub-segments with motivation, pain, outcome, context, trigger, awareness, sophistication, psychology, and market behavior) | Before a DCT wave (intent: "new ad concepts for <project>"). Requires buyer-profile.md + icp.md + offer.md. |
