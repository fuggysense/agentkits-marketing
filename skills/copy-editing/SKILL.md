...
description: "Edit and polish marketing copy via systematic multi-pass review. Triggers: edit copy, review copy, copy feedback, proofread, polish, make this better, copy sweep, improve writing, humanize text, de-ai, remove ai patterns, sound more human."
triggers:
  - edit copy
  - review copy
  - copy feedback
...
**References:**
- Read `references/overused-ai-patterns.md` for the marketing/copy prohibition catalog (HARD constraints — never use)
- Read `references/anti-ai-patterns.md` for the analytical/encyclopedic prohibition catalog (HARD constraints — covers different register than overused-ai-patterns)
...
Layer 2: overused-ai-patterns + anti-ai-patterns (universal prohibitions) — HARD constraints
Layer 3: corrections.md        (user session fixes)          — HARD constraints
Layer 4: V.O.I.C.E.            (positive voice target)       — write LIKE this
```

**Process:**
1. Read the full `overused-ai-patterns.md` + `anti-ai-patterns.md` reference files (Layer 2)
...
- `references/overused-ai-patterns.md` - Overused AI patterns reference, marketing/copy register (De-AI sweep catalog, HARD constraints)
- `references/anti-ai-patterns.md` - AI tells reference, analytical/encyclopedic register (De-AI sweep catalog, HARD constraints)
...
- [[copywriting]] (skill, 0.09)
- [[brand-voice-guardian]] (agent, 0.06)
- [[youtube-content]] (skill, 0.06)
- [[page-cro]] (skill, 0.05)
- [[copywriter]] (agent, 0.05)
