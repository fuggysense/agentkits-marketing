...
description: "Multi-agent parallel research: decomposes topic into 3-6 MECE angles, spawns sub-agents, runs gap analysis, synthesizes comprehensive findings. 90.2% better than single-agent (Anthropic eval). Triggers: deep research, thorough research, research everything about, cover every angle, comprehensive research, exhaustive research."
triggers:
  - deep research
  - thorough research
...
- [[researcher]] (agent, 0.08)
- [[multi-agent-consensus]] (skill, 0.07)
- [[source-of-truth]] (skill, 0.06)
- [[verification-loops]] (skill, 0.06)
- [[competitor-alternatives]] (skill, 0.05)
