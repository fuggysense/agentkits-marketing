...
description: "LinkedIn organic: profile audit, algorithm, content playbooks, creator mode, B2B sales, engagement, newsletters, organic-to-paid. Tools: profile analyzer, banner designer, content idea generator. Triggers: LinkedIn profile, optimization, strategy, algorithm, audit, newsletter."
triggers:
  - LinkedIn profile
...
|-------|-------------------------------|
| `researcher` | Profile optimization, algorithm strategy, growth tactics |
| `copywriter` | Headline formulas, about section copy, post hooks, CTA copy |
| `copywriter` | Content ideation, theme development, creative angles |
...
- [[email-marketing]] (skill, 0.21)
- [[seo-mastery]] (skill, 0.19)
- [[paid-advertising]] (skill, 0.18)
- [[content-strategy]] (skill, 0.18)
- [[analytics-attribution]] (skill, 0.14)
