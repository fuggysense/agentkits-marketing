...
description: "5-phase offer framework: discovery, viability scoring, identity extraction, micro offers, documents, audits, deployment. Triggers: build offer, offer builder, positioning, micro offer, viability, audit, score, create offer."
triggers:
  - build offer
  - offer builder
  - offer positioning
...
**Optional agent:** `copywriter` — generate objection handling scripts.
...
- **copywriter** — objection handling and sales collateral from audit findings
...
- [[business-profile]] (skill, 0.19)
- [[persona-builder]] (agent, 0.18)
- [[client-onboarding]] (skill, 0.16)
- [[avatar-research]] (skill, 0.15)
- [[email-sequence]] (skill, 0.15)
