...
description: "Optimize any marketing page (homepage, landing, pricing, feature, blog) for conversions. Triggers: CRO, conversion rate optimization, improve conversions, bounce rate, page optimization. NOT for: signup flows (signup-flow-cro), post-signup activation (onboarding-cro), forms (form-cro), popups (popup-cro)."
triggers:
  - CRO
