...
category: core
difficulty: advanced
description: "Systematic problem-solving for marketing: simplification cascades (complexity), collision-zone thinking (creative blocks), meta-pattern recognition (recurring patterns), inversion (assumptions), scale game (audience scaling). Triggers: stuck, problem, challenge, creative block, campaign issues, troubleshooting."
triggers:
  - stuck
  - problem
  - challenge
...
- [[brainstormer]] (agent, 0.10)
- [[marketing-fundamentals]] (skill, 0.07)
- [[content-strategy]] (skill, 0.07)
- [[email-marketing]] (skill, 0.06)
- [[brand-building]] (skill, 0.06)
