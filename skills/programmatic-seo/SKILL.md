...
category: seo-growth
difficulty: advanced
description: "Create SEO-driven pages at scale via templates & data. Triggers: pSEO 2.0, JSON-first pages, niche taxonomy, schema-driven content, template pages, directory/location/comparison pages, GEO, generative engine optimization. NOT for: SEO audits (use seo-audit)."
triggers:
  - programmatic SEO
  - pSEO 2.0
  - JSON-first pages
...
**Pipeline orchestration**: Use `researcher` agent for end-to-end pipeline management.
...
- [[marketing-ideas]] (skill, 0.20)
- [[competitor-alternatives]] (skill, 0.17)
- [[seo-mastery]] (skill, 0.17)
- [[unslop]] (skill, 0.14)
- [[business-profile]] (skill, 0.13)
