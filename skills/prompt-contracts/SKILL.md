...
difficulty: beginner
description: "Define success, constraints, output format, and failure conditions in a single structured contract. Auto-triggers on high-stakes work. Contract library + Reverse Prompt to extract contracts from winning assets. Triggers: prompt contract, define success, failure conditions, what does done look like."
triggers:
  - prompt contract
  - write a contract
...
- [[verification-loops]] (skill, 0.19)
- [[multi-agent-consensus]] (skill, 0.15)
- [[copywriting]] (skill, 0.13)
