...
category: utility
difficulty: beginner
description: "V4 marketing only — Scrape Creators wrapper at skills/scrapecreators/scripts/scrape.py with V4 brand/research integration. For global Scrape Creators access use pp-scrape-creators instead. Covers profiles, videos, posts, comments, transcripts, ad library across 25+ platforms. Triggers: V4 scrape, V4 social intelligence, scrape for client."
triggers:
  - scrape profile
  - social intelligence
  - competitor scan
...
- [[reddit]] (skill, 0.09)
- [[social-media]] (skill, 0.08)
- [[ad-library-scraper]] (skill, 0.08)
- [[transcribe]] (skill, 0.08)
- [[meta-ads-uploader]] (skill, 0.07)
