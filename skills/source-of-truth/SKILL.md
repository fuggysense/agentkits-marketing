...
- Used by agents: `[[researcher]], [[persona-builder]], [[copywriter]], [[brand-voice-guardian]]
...
4. **Hand-off message:**
   ...
   Suggested next steps:
     1. avatar-research skill      → "build avatars for <project>" — 3+ DCT avatars from this
     2. ad-concept-engine          → Conductor Mode "new ad concepts for <project>" — DCT batches (3 creatives × 2 headlines × 2 copies per angle)
...
- [[avatar-research]] (skill, 0.24)
- [[business-profile]] (skill, 0.24)
- [[persona-builder]] (agent, 0.24)
- [[onboarding-strategy-pdf]] (skill, 0.20)
- [[ad-concept-engine]] (skill, 0.19)
