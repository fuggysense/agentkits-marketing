...
description: "Domain-specific AI flaw detection. Generates empirical avoidance profiles via model sampling. Outputs: patterns to avoid, failure modes, cost/quality trade-offs. Run once per domain to produce a do-not-do-this list."
triggers:
  - unslop
...
Layer 2: copy-editing/references/{overused-ai-patterns,anti-ai-patterns}.md (universal static prohibitions — marketing/copy register + analytical/encyclopedic register)
...
|---|---|---|
| `copy-editing` (Sweep 8) | Match by content type | Second layer alongside `overused-ai-patterns.md` + `anti-ai-patterns.md` |
...
- `skills/copy-editing/references/overused-ai-patterns.md` — Static prohibition list, marketing/copy register (dedup target)
- `skills/copy-editing/references/anti-ai-patterns.md` — Static prohibition list, analytical/encyclopedic register (dedup target)
