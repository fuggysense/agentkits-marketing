...
| 5.4 | Delete confirmed-retired skills — 4× `seedance-*` (loop, motion, prompt) + retired `directors-cut` + retired global `video-director` + retired `filmmaking`. Replace with redirect stubs. | Skill folder cleanup | pending HITL |
